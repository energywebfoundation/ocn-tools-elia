...
ocn-registry set-node $OCN_NODE_URL -s 0x1c3e5453c0f9aa74a8eb0216310b2b013f017813a648fce364bf41dbc0b37647 --network-file ./networks.json &> /dev/null

# ensure flex service is up
until $(ocn-registry list-services --network-file ./networks.json | grep 0x2932b7A2355D6fecc4b5c0B6BD44cC31df247a2e &> /dev/null); do
